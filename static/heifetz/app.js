    ...
    xhr.onload = function () {
        if (xhr.status === 200) {
            ...
            for (i = 0; i < resp.data.length; i++) {
                ...
                if (user == null || resp.data[i].id != user.id) {
...
const topicsSelected = new Array();
//ask a question
